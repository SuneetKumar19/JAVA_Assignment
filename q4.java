        ...
        for(int i=0;i<t;i++)
        {
           ...
           Teaching_Assis  newta[] =  new Teaching_Assis[ta];
            ...
            for(int lol=0;lol<ta;lol++)
            {
                ...
                a=newta[lol].RollNo+" "+newta[lol].Name;
                if(lol!=ta-1)
                {
                     System.out.println(a);
               for(int ll=0;ll<taps;ll++)
                {
                    if(stu>=student)
                    {
                        break;
                    }
                    b=newst[stu].RollNo+" "+newst[stu].Name;
            ...
            {
                 System.out.println(a);
                for(int kop=stu;kop<student;kop++)
                {
                    b=newst[kop].RollNo+" "+newst[kop].Name;
                    System.out.println(b);
                }
            }
